package com.example.android_secret_code;
...
public class MainActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<List<SecretCode>>, SecretCodeAdapter.ItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView.setAdapter(new com.example.android_secret_code.SecretCodeAdapter(this, this));
    ...
    public void onLoadFinished(Loader<List<SecretCode>> loader, List<SecretCode> data) {
        ...
        ((com.example.android_secret_code.SecretCodeAdapter) recyclerView.getAdapter()).setData(data);
    }

    @Override
    public void onLoaderReset(Loader<List<SecretCode>> loader) {
        ((com.example.android_secret_code.SecretCodeAdapter) recyclerView.getAdapter()).setData(null);
    }
